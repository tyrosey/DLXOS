...
// L2_BITS=12.
#define	MEMORY_L1_PAGE_SIZE_BITS 19	// each entry in L1 is 512 KB
#define	MEMORY_L2_PAGE_SIZE_BITS 13	// each entry in L2 is 8 KB
...
#define TOP_VIRTUAL_ADDRESS_SPACE (L1_MAX_ENTRIES * L2_MAX_ENTRIES * MEMORY_PAGE_SIZE) // setting the virtual address space

#define L1_MAX_ENTRIES 0x20 // 32 entries for L1 
#define L2_MAX_ENTRIES 0x40 // 64 entries for L2 
