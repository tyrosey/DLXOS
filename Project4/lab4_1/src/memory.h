...
#define	MEMORY_L1_PAGE_SIZE_BITS 13	// each entry in L1 is 64 KB  --> CHANGED TO 8 KB
...
#define L1_MAX_ENTRIES 0x40	// max entries in the L1 table - 1 --> CHANGED TO 64
#define TOP_VIRTUAL_ADDRESS_SPACE  L1_MAX_ENTRIES * MEMORY_PAGE_SIZE // 64 entries * 8kb = 512 kb
